...
const Banner: React.FC = () => {
  ...
  return (
    <div className="relative text-center  lg:h-[calc(100vh-4rem)] w-full flex">
      {/* Left side with text */}
      <div className="w-1/2 flex flex-col justify-center items-start p-8">
        <h1 className="text-2xl sm:text-3xl lg:text-7xl font-bold mb-4 font-oswald">
        ...
        <button
          className="bg-custom-gradient-red hover:bg-custom-gradient-black text-white font-bold py-2 px-4 sm:py-2 sm:px-6 lg:py-3 lg:px-8 text-base sm:text-lg rounded mx-auto "
