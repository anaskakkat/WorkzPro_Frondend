...
const WorkerSlots: React.FC = () => {
  ...
  return (
    <div className="container flex justify-evenly lg:my-8 my-2 h-auto w-full p-8 sm:py-4 mx-auto border-2 gap-8 border-custom_lightBlue overflow-hidden">
      <div className=" container text-center flex border-2 w-auto ">
        {worker ? (
          <WorkeDays
